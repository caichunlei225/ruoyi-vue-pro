package cn.ccl.abu.module.pay.service.refund;

import cn.hutool.extra.spring.SpringUtil;
import cn.ccl.abu.framework.common.pojo.PageResult;
import cn.ccl.abu.framework.pay.core.client.PayClient;
import cn.ccl.abu.framework.pay.core.client.PayClientFactory;
import cn.ccl.abu.framework.pay.core.client.dto.refund.PayRefundRespDTO;
import cn.ccl.abu.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import cn.ccl.abu.framework.pay.core.enums.channel.PayChannelEnum;
import cn.ccl.abu.framework.pay.core.enums.refund.PayRefundStatusRespEnum;
import cn.ccl.abu.framework.test.core.ut.BaseDbAndRedisUnitTest;
import cn.ccl.abu.module.pay.api.refund.dto.PayRefundCreateReqDTO;
import cn.ccl.abu.module.pay.controller.admin.refund.vo.PayRefundExportReqVO;
import cn.ccl.abu.module.pay.controller.admin.refund.vo.PayRefundPageReqVO;
import cn.ccl.abu.module.pay.dal.dataobject.app.PayAppDO;
import cn.ccl.abu.module.pay.dal.dataobject.channel.PayChannelDO;
import cn.ccl.abu.module.pay.dal.dataobject.order.PayOrderDO;
import cn.ccl.abu.module.pay.dal.dataobject.refund.PayRefundDO;
import cn.ccl.abu.module.pay.dal.mysql.refund.PayRefundMapper;
import cn.ccl.abu.module.pay.dal.redis.no.PayNoRedisDAO;
import cn.ccl.abu.module.pay.enums.notify.PayNotifyTypeEnum;
import cn.ccl.abu.module.pay.enums.order.PayOrderStatusEnum;
import cn.ccl.abu.module.pay.enums.refund.PayRefundStatusEnum;
import cn.ccl.abu.module.pay.framework.pay.config.PayProperties;
import cn.ccl.abu.module.pay.service.app.PayAppService;
import cn.ccl.abu.module.pay.service.channel.PayChannelService;
import cn.ccl.abu.module.pay.service.notify.PayNotifyService;
import cn.ccl.abu.module.pay.service.order.PayOrderService;
...
import static cn.ccl.abu.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.ccl.abu.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.ccl.abu.framework.common.util.json.JsonUtils.toJsonString;
import static cn.ccl.abu.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.ccl.abu.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.ccl.abu.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.ccl.abu.framework.test.core.util.RandomUtils.randomPojo;
import static cn.ccl.abu.framework.test.core.util.RandomUtils.randomString;
import static cn.ccl.abu.module.pay.enums.ErrorCodeConstants.*;
