package cn.ccl.abu.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.StrUtil;
import cn.ccl.abu.framework.common.pojo.PageResult;
import cn.ccl.abu.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import cn.ccl.abu.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import cn.ccl.abu.module.mp.convert.message.MpMessageConvert;
import cn.ccl.abu.module.mp.dal.dataobject.account.MpAccountDO;
import cn.ccl.abu.module.mp.dal.dataobject.message.MpMessageDO;
import cn.ccl.abu.module.mp.dal.dataobject.user.MpUserDO;
import cn.ccl.abu.module.mp.dal.mysql.message.MpMessageMapper;
import cn.ccl.abu.module.mp.enums.message.MpMessageSendFromEnum;
import cn.ccl.abu.module.mp.framework.mp.core.MpServiceFactory;
import cn.ccl.abu.module.mp.framework.mp.core.util.MpUtils;
import cn.ccl.abu.module.mp.service.account.MpAccountService;
import cn.ccl.abu.module.mp.service.material.MpMaterialService;
import cn.ccl.abu.module.mp.service.message.bo.MpMessageSendOutReqBO;
import cn.ccl.abu.module.mp.service.user.MpUserService;
...
import static cn.ccl.abu.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
