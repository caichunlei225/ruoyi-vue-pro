package cn.ccl.abu.module.infra.service.logger;
...
import cn.ccl.abu.module.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
...
import cn.ccl.abu.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.ccl.abu.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.ccl.abu.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.ccl.abu.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        reqVO.setApplicationName("abu-test");
