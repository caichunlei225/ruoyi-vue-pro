package cn.ccl.abu.module.infra.controller.admin.logger.vo.apierrorlog;

import cn.ccl.abu.framework.excel.core.annotations.DictFormat;
import cn.ccl.abu.framework.excel.core.convert.DictConvert;
import cn.ccl.abu.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(cn.ccl.abu.module.system.enums.DictTypeConstants.USER_TYPE)
