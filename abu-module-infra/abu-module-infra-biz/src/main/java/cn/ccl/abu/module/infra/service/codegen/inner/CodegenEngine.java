package cn.ccl.abu.module.infra.service.codegen.inner;
...
import cn.ccl.abu.framework.common.exception.util.ServiceExceptionUtil;
...
import cn.ccl.abu.framework.excel.core.annotations.DictFormat;
import cn.ccl.abu.framework.excel.core.convert.DictConvert;
import cn.ccl.abu.framework.excel.core.util.ExcelUtils;
import cn.ccl.abu.framework.mybatis.core.dataobject.BaseDO;
...
import cn.ccl.abu.framework.operatelog.core.enums.OperateTypeEnum;
import cn.ccl.abu.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import cn.ccl.abu.module.infra.dal.dataobject.codegen.CodegenTableDO;
import cn.ccl.abu.module.infra.enums.codegen.CodegenFrontTypeEnum;
import cn.ccl.abu.module.infra.enums.codegen.CodegenSceneEnum;
import cn.ccl.abu.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "abu-module-${table.moduleName}/" + // 顶级模块
                "abu-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "abu-module-${table.moduleName}/" + // 顶级模块
                "abu-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "abu-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "abu-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
