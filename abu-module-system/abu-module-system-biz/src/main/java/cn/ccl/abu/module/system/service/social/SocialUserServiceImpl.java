...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 AbuAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private AbuAuthRequestFactory abuAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = abuAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
