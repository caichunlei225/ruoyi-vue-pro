package cn.ccl.abu.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.ccl.abu.framework.common.enums.CommonStatusEnum;
import cn.ccl.abu.framework.common.exception.ServiceException;
import cn.ccl.abu.framework.common.pojo.PageResult;
import cn.ccl.abu.framework.common.util.collection.ArrayUtils;
...
import cn.ccl.abu.module.infra.api.file.FileApi;
import cn.ccl.abu.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.ccl.abu.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.ccl.abu.module.system.controller.admin.user.vo.user.*;
import cn.ccl.abu.module.system.dal.dataobject.dept.DeptDO;
import cn.ccl.abu.module.system.dal.dataobject.dept.PostDO;
import cn.ccl.abu.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.ccl.abu.module.system.dal.mysql.dept.UserPostMapper;
import cn.ccl.abu.module.system.dal.mysql.user.AdminUserMapper;
import cn.ccl.abu.module.system.enums.common.SexEnum;
import cn.ccl.abu.module.system.service.dept.DeptService;
import cn.ccl.abu.module.system.service.dept.PostService;
import cn.ccl.abu.module.system.service.permission.PermissionService;
import cn.ccl.abu.module.system.service.tenant.TenantService;
...
import static cn.ccl.abu.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("abuyuanma");
        ...
        assertEquals("abuyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("abuyuanma"))).thenReturn("java");
