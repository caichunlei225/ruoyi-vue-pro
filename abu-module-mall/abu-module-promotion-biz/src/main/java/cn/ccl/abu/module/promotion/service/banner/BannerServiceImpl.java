package cn.ccl.abu.module.promotion.service.banner;

import cn.ccl.abu.framework.common.pojo.PageResult;
import cn.ccl.abu.module.promotion.controller.admin.banner.vo.BannerCreateReqVO;
import cn.ccl.abu.module.promotion.controller.admin.banner.vo.BannerPageReqVO;
import cn.ccl.abu.module.promotion.controller.admin.banner.vo.BannerUpdateReqVO;
import cn.ccl.abu.module.promotion.convert.banner.BannerConvert;
import cn.ccl.abu.module.promotion.dal.dataobject.banner.BannerDO;
import cn.ccl.abu.module.promotion.dal.mysql.banner.BannerMapper;
...
import static cn.ccl.abu.module.promotion.enums.ErrorCodeConstants.BANNER_NOT_EXISTS;
