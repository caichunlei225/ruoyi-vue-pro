package cn.ccl.abu.module.trade.convert.order;
...
import cn.ccl.abu.framework.common.util.string.StrUtils;
...
import cn.ccl.abu.module.pay.enums.DictTypeConstants;
...
import cn.ccl.abu.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.ccl.abu.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.ccl.abu.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.ccl.abu.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.ccl.abu.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.ccl.abu.module.trade.controller.admin.order.vo.*;
import cn.ccl.abu.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.ccl.abu.module.trade.controller.app.order.vo.*;
import cn.ccl.abu.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.ccl.abu.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import static cn.ccl.abu.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.ccl.abu.framework.common.util.date.LocalDateTimeUtils.addTime;
