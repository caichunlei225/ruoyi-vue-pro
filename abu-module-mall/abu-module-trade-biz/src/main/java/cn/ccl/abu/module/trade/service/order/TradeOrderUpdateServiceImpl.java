package cn.ccl.abu.module.trade.service.order;
...
import cn.ccl.abu.framework.common.core.KeyValue;
import cn.ccl.abu.framework.common.enums.TerminalEnum;
import cn.ccl.abu.framework.common.util.collection.CollectionUtils;
import cn.ccl.abu.framework.common.util.json.JsonUtils;
import cn.ccl.abu.module.member.api.address.AddressApi;
import cn.ccl.abu.module.member.api.address.dto.AddressRespDTO;
import cn.ccl.abu.module.member.api.level.MemberLevelApi;
import cn.ccl.abu.module.member.api.point.MemberPointApi;
import cn.ccl.abu.module.member.api.user.MemberUserApi;
...
import cn.ccl.abu.module.member.enums.point.MemberPointBizTypeEnum;
import cn.ccl.abu.module.pay.api.order.PayOrderApi;
import cn.ccl.abu.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.ccl.abu.module.pay.api.order.dto.PayOrderRespDTO;
import cn.ccl.abu.module.pay.enums.order.PayOrderStatusEnum;
import cn.ccl.abu.module.product.api.comment.ProductCommentApi;
import cn.ccl.abu.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.ccl.abu.module.product.api.sku.ProductSkuApi;
import cn.ccl.abu.module.promotion.api.bargain.BargainActivityApi;
import cn.ccl.abu.module.promotion.api.bargain.BargainRecordApi;
import cn.ccl.abu.module.promotion.api.combination.CombinationRecordApi;
import cn.ccl.abu.module.promotion.api.combination.dto.CombinationRecordRespDTO;
import cn.ccl.abu.module.promotion.api.coupon.CouponApi;
import cn.ccl.abu.module.promotion.api.coupon.dto.CouponUseReqDTO;
import cn.ccl.abu.module.promotion.api.seckill.SeckillActivityApi;
import cn.ccl.abu.module.promotion.api.seckill.dto.SeckillActivityUpdateStockReqDTO;
import cn.ccl.abu.module.promotion.enums.combination.CombinationRecordStatusEnum;
import cn.ccl.abu.module.trade.controller.admin.order.vo.TradeOrderDeliveryReqVO;
import cn.ccl.abu.module.trade.controller.admin.order.vo.TradeOrderRemarkReqVO;
import cn.ccl.abu.module.trade.controller.admin.order.vo.TradeOrderUpdateAddressReqVO;
import cn.ccl.abu.module.trade.controller.admin.order.vo.TradeOrderUpdatePriceReqVO;
import cn.ccl.abu.module.trade.controller.app.order.vo.AppTradeOrderCreateReqVO;
import cn.ccl.abu.module.trade.controller.app.order.vo.AppTradeOrderSettlementReqVO;
import cn.ccl.abu.module.trade.controller.app.order.vo.AppTradeOrderSettlementRespVO;
import cn.ccl.abu.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.ccl.abu.module.trade.convert.order.TradeOrderConvert;
import cn.ccl.abu.module.trade.dal.dataobject.cart.CartDO;
import cn.ccl.abu.module.trade.dal.dataobject.order.TradeOrderDO;
import cn.ccl.abu.module.trade.dal.dataobject.order.TradeOrderItemDO;
import cn.ccl.abu.module.trade.dal.mysql.order.TradeOrderItemMapper;
import cn.ccl.abu.module.trade.dal.mysql.order.TradeOrderMapper;
import cn.ccl.abu.module.trade.dal.redis.no.TradeOrderNoRedisDAO;
import cn.ccl.abu.module.trade.enums.ErrorCodeConstants;
import cn.ccl.abu.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import cn.ccl.abu.module.trade.enums.delivery.DeliveryTypeEnum;
import cn.ccl.abu.module.trade.enums.order.*;
import cn.ccl.abu.module.trade.framework.order.config.TradeOrderProperties;
import cn.ccl.abu.module.trade.service.brokerage.record.BrokerageRecordService;
import cn.ccl.abu.module.trade.service.brokerage.bo.BrokerageAddReqBO;
import cn.ccl.abu.module.trade.service.cart.CartService;
import cn.ccl.abu.module.trade.service.delivery.DeliveryExpressService;
import cn.ccl.abu.module.trade.service.message.TradeMessageService;
import cn.ccl.abu.module.trade.service.message.bo.TradeOrderMessageWhenDeliveryOrderReqBO;
import cn.ccl.abu.module.trade.service.price.TradePriceService;
import cn.ccl.abu.module.trade.service.price.bo.TradePriceCalculateReqBO;
import cn.ccl.abu.module.trade.service.price.bo.TradePriceCalculateRespBO;
...
import static cn.ccl.abu.framework.common.util.collection.CollectionUtils.*;
import static cn.ccl.abu.module.pay.enums.ErrorCodeConstants.ORDER_UPDATE_PRICE_FAIL_EQUAL;
import static cn.ccl.abu.module.pay.enums.ErrorCodeConstants.ORDER_UPDATE_PRICE_FAIL_PAID;
import static cn.ccl.abu.module.trade.enums.ErrorCodeConstants.*;
