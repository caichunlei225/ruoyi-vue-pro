...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.ccl.abu";
    private static final String ARTIFACT_ID = "abu";
    private static final String PACKAGE_NAME = "cn.ccl.abu";
    private static final String TITLE = "阿布管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.ccl.abu";
        String artifactIdNew = "abu";
        String packageNameNew = "cn.ccl.abu";
        String titleNew = "阿布管理系统";
        String projectBaseDirNew = "/Users/ccl/IdeaProjects/abu-vue-pro"; // 一键改名后，“新”项目所在的目录
