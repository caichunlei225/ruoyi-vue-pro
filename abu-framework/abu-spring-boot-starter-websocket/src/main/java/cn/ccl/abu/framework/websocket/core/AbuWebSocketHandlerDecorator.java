package cn.ccl.abu.framework.websocket.core;
...
public class AbuWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public AbuWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
