package cn.ccl.abu.framework.tracer.config;

import cn.ccl.abu.framework.common.enums.WebFilterOrderEnum;
import cn.ccl.abu.framework.tracer.core.aop.BizTraceAspect;
import cn.ccl.abu.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "abu.tracer", value = "enable", matchIfMissing = true)
public class AbuTracerAutoConfiguration {
