package cn.ccl.abu.framework.mq.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import cn.ccl.abu.framework.common.enums.DocumentEnum;
import cn.ccl.abu.framework.mq.core.RedisMQTemplate;
import cn.ccl.abu.framework.mq.core.interceptor.RedisMessageInterceptor;
import cn.ccl.abu.framework.mq.core.pubsub.AbstractChannelMessageListener;
import cn.ccl.abu.framework.mq.core.stream.AbstractStreamMessageListener;
import cn.ccl.abu.framework.mq.job.RedisPendingMessageResendJob;
...
public class AbuMQAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "abu.mq.redis.pubsub", value = "enable", matchIfMissing = true) // 允许使用 abu.mq.redis.pubsub.enable=false 禁用多租户
    ...
    @ConditionalOnProperty(prefix = "abu.mq.redis.stream", value = "enable", matchIfMissing = true) // 允许使用 abu.mq.redis.stream.enable=false 禁用多租户
